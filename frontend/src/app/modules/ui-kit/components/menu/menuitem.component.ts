...
import { QMenuService } from './menu.service';
...
export class QMenuitemComponent implements OnInit, OnDestroy {
    @Input() parentRef: any = {};
    @Input() item: any;
    ...
    constructor(private qThemeService: QThemeService, public router: Router, private menuService: QMenuService) {
    ...
    itemClick(event: Event) {
        ...
        if (this.item.items) {
            ...
            // hide overlay menus
            this.parentRef.menuActiveMobile = false;

            if (this.parentRef.isDesktop() && this.qThemeService.isOverlay()) {
                this.parentRef.menuInactiveDesktop = true;
            }
        }
    }
